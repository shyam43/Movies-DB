...
public class ListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void onBindGenericItemViewHolder(final CharacterViewHolder holder, int position) {
        holder.name.setText(mCharacterList.get(position).getTitle());

        String characterImageUrl = mCharacterList.get(position).getImageUrl();
        characterImageUrl = "https://api.themoviedb.org/3/search/movie/"
                + characterImageUrl + "?api_key=b6f21cf08123c048d122efbba7293173";
