...
public class DataManager {
    ...
    public void getCharactersList(int offSet, String searchQuery, int page,
                                  RemoteCallback<ResultsWrapper> listener) {
    ...
    public void getCharacter(long characterId, RemoteCallback<ResultsWrapper> listener) {
